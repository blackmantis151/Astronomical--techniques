...
condi_bkg=where(wave ge 4950 and wave le 5000)
...
condi=where(wave ge 5070.0-100.0 and wave le  5070+100.0); 8936.15 is decided based on bestfit
...
device,filename='Spectrum_OII_zoom_Gaussfit.ps',/color
;multiplot,[1,2];,ygap=0.00004

plotsym,0,0.5,/fill
plot, wave, flux-mean_bkg_model, psym=-8, color=0, xtitle='Wavelength (Angstrom)', $
      ytitle='Flux', linestyle=0, thick=0.001, xrange=[5070-100,5070+100],/xstyle,yrange=[-3,10],/ystyle
...
;Halpha
oplot,[plamb(7),plamb(7)],[2,10],linestyle=2,color=4,thick=3
xyouts,plamb(7),7,'OII',charsize=1.2,orientation=90
...
ppt[1].fixed=0
ppt[1].limited(0) =1
ppt[1].limits(0)=5050.-10.;ppt_start(1)-0.50D
ppt[1].limits(1)=5050.+10;ppt_start(1)+0.750D
;;
ppt[2].fixed=0
ppt[2].limited(0) =1
...
Ha_redshift=(Ha_shifted-lamb0(7))/lamb0(7)
Velocity=(3e+5)*(Ha_redshift)

print,Ha_shifted,lamb0(7),Ha_shifted-lamb0(7),Velocity, Ha_redshift
