...
condi_bkg=where(wave ge 5261-100 and wave le 5261+100)
...
condi=where(wave ge  5261.0-100.0 and wave le  5261+100.0); 8936.15 is decided based on bestfit
...
device,filename='Spectrum_NeIII_zoom_Gaussfit.ps',/color
;multiplot,[1,2];,ygap=0.00004

plotsym,0,0.5,/fill
plot, wave, flux-mean_bkg_model, psym=-8, color=0, xtitle='Wavelength (Angstrom)', $
      ytitle='Flux', linestyle=0, thick=0.001, xrange=[5250-100,5250+100],/xstyle,yrange=[-1,10],/ystyle
...
;Halpha
oplot,[plamb(10),plamb(10)],[2,10],linestyle=2,color=4,thick=3
xyouts,plamb(10),7,'NeIII',charsize=1.2,orientation=90
...
ppt[1].fixed=0
ppt[1].limited(0) =1
ppt[1].limits(0)=5261.-10.;ppt_start(1)-0.50D
ppt[1].limits(1)=5261.+10;ppt_start(1)+0.750D
;;
ppt[2].fixed=0
ppt[2].limited(0) =1
...
Ha_redshift=(Ha_shifted-lamb0(10))/lamb0(10)
Velocity=(3e+5)*(Ha_redshift)
print,'Hb-shifted A, Hb A, Hbshifted-Hb A, Vel (km/s), Redshift '
print,Ha_shifted,lamb0(10),Ha_shifted-lamb0(10),Velocity, Ha_redshift
