...
condi=where(wave ge 6745.0-100.0 and wave le  6745.0+100.0); 8936.15 is decided based on bestfit
...
device,filename='Spectrum_OIII1_zoom_Gaussfit.ps',/color
;multiplot,[1,2];,ygap=0.00004

plotsym,0,0.5,/fill
plot, wave, flux-mean_bkg_model, psym=-8, color=0, xtitle='Wavelength (Angstrom)', $
      ytitle='Flux', linestyle=0, thick=0.001, xrange=[6745-100,6745+100],/xstyle,yrange=[-3,10],/ystyle
...
;Halpha
oplot,[plamb(8),plamb(8)],[2,10],linestyle=2,color=4,thick=3
xyouts,plamb(8),7,'OIII1',charsize=1.2,orientation=90
...
ppt[1].fixed=0
ppt[1].limited(0) =1
ppt[1].limits(0)=6745.-10.;ppt_start(1)-0.50D
ppt[1].limits(1)=6745.+10;ppt_start(1)+0.750D
;;
ppt[2].fixed=0
ppt[2].limited(0) =1
...
Ha_redshift=(Ha_shifted-lamb0(8))/lamb0(8)
Velocity=(3e+5)*(Ha_redshift)

print,'For OIII1 line----'

print,Ha_shifted,lamb0(8),Ha_shifted-lamb0(8),Velocity, Ha_redshift
